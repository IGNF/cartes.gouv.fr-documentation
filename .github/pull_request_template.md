...
_à compléter : décrire succinctement les changements et préciser s'il y a des informations de contexte à porter à connaissance des relecteurs, notamment une échéance de déploiement souhaitée._

## Checklist

Placer un x entre les crochets, ou cocher après création de la PR les cases qui concernent les changements apportés

- [ ] J'ai visualisé le rendu en local pour m'assurer qu'il était cohérent et conforme à mes attentes.
- [ ] J'ai vérifié l'orthographe et la grammaire et respecté les consignes typographiques (apostrophes, guillemets, espaces insécables notamment).
- [ ] J'ai créé un nouveau fichier ou renommé un fichier existant. Le nom du fichier ne comprend que des chiffres, des caractères minuscules et des tirets (ex : `nouveau-contenu.md`). Et si c'est dans une rubrique d'actualités, le nom du fichier commence si possible par année et mois (ex : `2026-08-mise-a-jour-wms.md`)
