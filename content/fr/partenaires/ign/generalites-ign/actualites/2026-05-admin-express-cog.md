...
![Offre Admin Express](/img/partenaires/ign/generalites/actualites/2026-05-admin-express-cog/00-admin-express-cog.png){.fr-responsive-img .frx-img-contained}

Avec plusieurs nouveautés existantes ou à venir très prochainement :

<ol>
  <li>
    Ajout d’une couche supplémentaire <code>CARTO_PLUS</code> qui conserve l’échelle des DROM (ce qui permet de visualiser la taille réelle de la Guyane par rapport à la Métropole).

    {% imageContent "/img/partenaires/ign/generalites/actualites/2026-05-admin-express-cog/01-admin-express-cog.png", "Disponible depuis 2025 : une couche CARTO_PLUS sans conservation d’échelle appelée : ADE-COG-CARTOPLUS-SANS-ECHELLE_4-0_GPKG_LAMB93_FRA-ED2026-01-01.gpkg" %}

    {% imageContent "/img/partenaires/ign/generalites/actualites/2026-05-admin-express-cog/02-admin-express-cog.png", "Disponible depuis 2026 : Offre CARTO-PLUS enrichie avec 2 couches : Sans et avec conservation d’échelle des DROM : ADE-COG-CARTOPLUS-AVEC-ECHELLE_4-0_GPKG_LAMB93_FRA-ED2026-01-01.gpkg" %}
  </li>
  <li>
    Ajout de 2 nouveaux formats en téléchargement pour ADMIN EXPRESS COG : GeoParquet et FlatGeobuf (disponibles uniquement à l’échelle France entière « FRA » en WGS84)
  ...
  <li>
    Prochainement (<strong>prévu fin juin</strong>) : Ajout d’un attribut [SIRET] sur les 8 classes de chefs-lieux (ponctuels). Cette information a été initialisée par l’IGN et sera consolidée avec l’INSEE pour le prochain millésime 2027. Cette information permet des croisements facilités avec d’autres bases comme BANATIC.
  ...
  <li>
    Limites d’IRIS 2026, référentiel géographique de la description des IRIS (îlots regroupés pour l’information statistique) recalés sur les surfaces administratives Admin EXPRESS/BD TOPO®. Co-produite et co-éditée avec l’INSEE.

    ![Offre IRIS](/img/partenaires/ign/generalites/actualites/2026-05-admin-express-cog/04-admin-express-cog.png){.fr-responsive-img .frx-img-contained}
