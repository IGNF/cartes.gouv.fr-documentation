...
Dans la BD TOPO® qui sera publiée <a aria-describedby="tooltip-1" id="link-2" href="#" class="fr-link">mi-octobre</a><span class="fr-tooltip fr-placement" id="tooltip-1" role="tooltip">Pour rappel, troisième édition de l’année, la prochaine sera en Décembre pour une diffusion en Janvier 2025.</span>, au sein du thème hydrographique, vous trouverez sur les tronçons hydrographiques un nouvel attribut « inventaire police de l’eau ». 4 valeurs sont possibles : <a aria-describedby="tooltip-1" id="link-2" href="#" class="fr-link">inscrit, non inscrit, expertise en cours et sans valeur</a><span class="fr-tooltip fr-placement" id="tooltip-1" role="tooltip">Inscrit : Indique que le tronçon hydrographique est inscrit au titre de la police de l’eau. Non inscrit : Indique que le tronçon hydrographique n’est pas inscrit au titre de la police de l’eau. Expertise en cours : Indique que l’écoulement est en attente de qualification définitive par le partenaire habilité (DDT(M)). Sans valeur : l’information d’inscription ou non de l’écoulement au titre de la police de l’eau n’a pas été fournie par la DDT(M) compétente.</span>. D’où proviennent ces informations ? 
...
:::info
**Zoom sur les ZNT (Zone de non traitement) point d’eau**
