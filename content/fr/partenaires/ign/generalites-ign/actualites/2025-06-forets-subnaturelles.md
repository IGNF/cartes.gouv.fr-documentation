---
title: De nouvelles bases de données au service de la détection des forêts subnaturelles
...
- **ainsi qu’une cartographie des zones où il est possible de trouver des forêts subnaturelles et des zones où cela est exclu&ast;.**

<br>

<p class="fr-text--sm">* Bien-sûr, il sera nécessaire de mener des prospections terrain à l’intérieur des zones où il est possible d’en trouver afin d’isoler les forêts respectant l’ensemble des critères, indicateurs et seuils définis par le Plan national d’actions Vieux bois et Forêts subnaturelles pour identifier les forêts subnaturelles.</p>

![Exemple de BD Forêts anciennes®. En vert foncé ce sont le Forêts anciennes, en vert clair les forêts récentes, en rose les zones déboisées entre les deux dates.](/img/partenaires/ign/generalites/actualites/2025-06-forets-subnaturelles/2025-06-forets-subnaturelles1.png){.fr-responsive-img .frx-img-contained}
...
Un peu de documentation ici : [Forêts anciennes Version 1.0 - Descriptif de contenu](https://data.geopf.fr/annexes/ressources/documentation/DC_For%C3%AAts_anciennes.pdf)

![Exemple de cartographie des forêts anciennes dans le département du Var (source : IGN, BD Foret anciennes®)](/img/partenaires/ign/generalites/actualites/2025-06-forets-subnaturelles/2025-06-forets-subnaturelles2.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Cartographie des zones à prospecter](/img/partenaires/ign/generalites/actualites/2025-06-forets-subnaturelles/2025-06-forets-subnaturelles3.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
**Définition d’une forêt subnaturelle :**

Une forêt subnaturelle combine un fort degré de maturité, de naturalité et un caractère ancien. Cette combinaison est évaluée pour les forêts françaises de métropole à l’aide d’une liste d’indicateurs établie sur la base des travaux de la Commission européenne (Guidelines UE - mars 2023), de la littérature scientifique et des travaux des experts du Conseil scientifique du PNA vieux bois et forêts subnaturelles. Ces indicateurs sont précisés dans le tableau ci-dessous, et seules les forêts respectant les seuils et critères de subnaturalité de l’ensemble de ces indicateurs seront qualifiées de forêts subnaturelles.

![Tableau de définitions](/img/partenaires/ign/generalites/actualites/2025-06-forets-subnaturelles/2025-06-forets-subnaturelles4.png){.fr-responsive-img .frx-img-contained}

Des indicateurs complémentaires définis dans le PNA, comme la diversité des stades de saproxylation ou la diversité des formes de dendromicrohabitats permettront de hiérarchiser le degré de subnaturalité des forêts étudiées.

---

La cartographie des forêts anciennes est désormais disponible sur le territoire métropolitain en [téléchargement](https://cartes.gouv.fr/rechercher-une-donnee/dataset/IGNF_BD-FORETS-ANCIENNES) et sur les [services géoplateforme de diffusion](/fr/guides-utilisateur/utiliser-les-services-de-la-geoplateforme/diffusion/) sous le nom « IGNF_FORETS-ANCIENNES ».

La cartographie des zones à prospecter pour identifier les forêts subnaturelles est disponible en [téléchargement](https://cartes.gouv.fr/rechercher-une-donnee/dataset/IGNF_PNA-ZONES-A-PROSPECTER) sur les [services géoplateforme de diffusion](/fr/guides-utilisateur/utiliser-les-services-de-la-geoplateforme/diffusion/) sous le nom « ZONES-A-PROSPECTER-FORETS-SUBNATURELLES ».

N’hésitez pas à partager avec nous vos réutilisations de ces bases de données, sur les réseaux avec le #IGNdata ou par courriel à l’adresse : <contact.geoservices@ign.fr>.