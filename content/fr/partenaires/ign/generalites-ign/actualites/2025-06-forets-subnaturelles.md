...
![Exemple de BD Forêts anciennes®. En vert foncé ce sont le Forêts anciennes, en vert clair les forêts récentes, en rose les zones déboisées entre les deux dates.](/img/partenaires/ign/generalites/actualites/2025-06-forets-subnaturelles1.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Exemple de cartographie des forêts anciennes dans le département du Var (source : IGN, BD Foret anciennes®)](/img/partenaires/ign/generalites/actualites/2025-06-forets-subnaturelles2.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Tableau de définitions](/img/partenaires/ign/generalites/actualites/2025-06-forets-subnaturelles4.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
N’hésitez pas à partager avec nous vos réutilisations de ces bases de données, sur les réseaux avec le #IGNdata ou par email à l’adresse : contact.geoservices@ign.fr
