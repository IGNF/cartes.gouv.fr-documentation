...
{% imageContent "/img/partenaires/ign/generalites/actualites/2026-07-plan-ign-hd-et-sentiers/00-plan-ign-hd-et-sentiers.webp", "Sentiers de randonnée balisés sur fond de Plan IGN HD" %}
...
La technique utilisée exploite la précision centimétrique des données LiDAR HD pour produire une représentation cartographique du sursol à grande échelle au 1:5 000. Le résultat final est l’empilement de nombreuses données, vectorielles pour certaines, images pour d’autres :
