...
![Image illustrative](/img/partenaires/ign/generalites/actualites/2026-07-mises-a-jour/00-2026-07-mises-a-jour.png "Mise à jour 00"){.fr-responsive-img .frx-img-contained style="border: 1px solid #000000; box-shadow: 0 12px 30px rgba(0, 0, 0, 0.35);"}
<figcaption class="fr-content-media__caption fr-mb-6v" style="text-align: center;">Actualité Mise à jour le 1 juillet 2026</figcaption>
...
![Image illustrative](/img/partenaires/ign/generalites/actualites/2026-07-mises-a-jour/01-2026-07-mises-a-jour.png "Mise à jour 01"){.fr-responsive-img .frx-img-contained style="border: 1px solid #000000; box-shadow: 0 12px 30px rgba(0, 0, 0, 0.35);"}
<figcaption class="fr-content-media__caption fr-mb-6v" style="text-align: center;">PLAN IGN - Langres (52)</figcaption>
...
{{ component("table", {
    ...
    data: [
        ...
        ['<a href="https://cartes.gouv.fr/rechercher-une-donnee/dataset/IGNF_BD-TOPO" target="_blank" rel="noopener noreferrer" title="BD TOPO® - ouvre une nouvelle fenêtre">BD TOPO® </a>', "France entière (FlatGeobuf, GeoParquet, GPKG + SQL), par territoires (SQL), par régions (GPKG + SHP), par départements (SHP) + thème transport", "Edition 2026-06"],   
...
![Image illustrative](/img/partenaires/ign/generalites/actualites/2026-07-mises-a-jour/02-2026-07-mises-a-jour.png "Mise à jour 02"){.fr-responsive-img .frx-img-contained style="border: 1px solid #000000; box-shadow: 0 12px 30px rgba(0, 0, 0, 0.35);"}
<figcaption class="fr-content-media__caption fr-mb-6v" style="text-align: center;">BD ORTHO® IRC - Nancy (54)</figcaption>