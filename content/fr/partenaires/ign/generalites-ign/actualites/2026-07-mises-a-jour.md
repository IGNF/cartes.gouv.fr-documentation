...
{{ component("table", {
    ...
    data: [
        ...
        ['<a href="https://cartes.gouv.fr/rechercher-une-donnee/dataset/IGNF_BD-TOPO" target="_blank" rel="noopener noreferrer" title="BD TOPO® - ouvre une nouvelle fenêtre">BD TOPO® </a>', "France entière (FlatGeobuf, GeoParquet, GPKG + SQL), par territoires (GPJKG + SQL), par régions (GPKG + SHP), par départements (SHP) + thème transport", "Edition 2026-06"],   
