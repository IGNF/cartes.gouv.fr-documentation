...
![RPG et BD Ortho](/img/partenaires/ign/generalites/actualites/2025-09-mises-a-jour/2025-09-bandeau-rpg.png){fr-responsive-img .frx-img-contained}
...
{{ component("table", {
    ...
    data: [
        ['Forêts anciennes', 'IGNF_FORETS-ANCIENNES', 'WMTS, WMS-Raster', 'environnement', 'N/A'],
        ['Forêts subnaturelles', 'ZONES-A-PROSPECTER-FORETS-SUBNATURELLES', 'WMTS, WMS-Raster', 'environnement', 'N/A'],
        ['SCAN Régional®', 'IGNF_CARTES_SCAN-REGIONAL', 'WMTS, WMS-Raster', 'cartes', 'N/A'],
        ['SCAN 1000®', 'IGNF_CARTES_SCAN-1000', 'WMTS, WMS-Raster', 'cartes', 'N/A'],
        ['Installations photovoltaïques au sol 2017-2020', 'GNF_PHOTOVOLTAIQUE-SOL_2017-2020', 'WMTS, WMS-Raster', 'ocsge', 'N/A'],
        ['Installations photovoltaïques au sol 2021-2023', 'IGNF_PHOTOVOLTAIQUE-SOL_2021-2023', 'WMTS, WMS-Raster', 'ocsge', 'N/A'],
...
{{ component("table", {
    headers: ["Donnée", "Nom technique", "Service", "Thématique", "Édition ou emprise"],
    data: [
        ['SCAN 100®', 'IGNF_CARTES_SCAN-100', 'WMTS, WMS-Raster', 'cartes', 'N/A']
    ]
}) }}
...
![IGN-F - BD Uni J+1 et MNS issu du LiDAR HD - Gap (05)](/img/partenaires/ign/generalites/actualites/2025-09-mises-a-jour/2025-09-bdunij1-gap.png){fr-responsive-img .frx-img-contained}
...
{{ component("table", {
    ...
    data: [
        ...
        ['<a href="https://cartes.gouv.fr/rechercher-une-donnee/dataset/IGNF_PNA-ZONES-A-PROSPECTER" target="_blank" rel="noopener noreferrer" title="Zones à prospecter pour les forêts subnaturelles - ouvre une nouvelle fenêtre">Zones à prospecter pour les forêts subnaturelles</a> format GPKG', 'FXX', 'N/A'],
...
![IGN-F - Admin Express et BD Ortho - Crocq (23)](/img/partenaires/ign/generalites/actualites/2025-09-mises-a-jour/2025-09-admin-express-crocq.png){fr-responsive-img .frx-img-contained}