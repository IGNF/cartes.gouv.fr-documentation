...
![Créer une clé d’accès](/img/partenaires/ign/acces-aux-donnes-scan/hash-acces-donnees-non-libres/01_creer-cle-acces.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Services accessibles](/img/partenaires/ign/acces-aux-donnes-scan/hash-acces-donnees-non-libres/02_services-accessibles.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Options de sécurisation](/img/partenaires/ign/acces-aux-donnes-scan/hash-acces-donnees-non-libres/03_options-securisation.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![apikey](/img/partenaires/ign/acces-aux-donnes-scan/hash-acces-donnees-non-libres/04_apikey.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
Pour télécharger les données, veuillez consulter ce <a href="https://data.geopf.fr/annexes/ressources/documentation/SCANs_Telechargement.txt" target="_blank" rel="noopener noreferrer" title="Méthode Download (TXT)"> fichier TXT</a>.
...
![Clé HASH](/img/partenaires/ign/acces-aux-donnes-scan/hash-acces-donnees-non-libres/05_cle-hash.png){.fr-responsive-img .frx-border-img .frx-img-contained}
