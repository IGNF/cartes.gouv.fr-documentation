...
Cliquez ensuite sur **« Ajouter un entrepôt »**.

![Ajouter un entrepôt](/img/partenaires/ign/representations-cartographiques-souveraines/creation-cles-donnees-scan/rejoindre-espace/02_ajouter-entrepot.png){.fr-responsive-img .frx-border-img .frx-img-contained}

Cliquez ensuite sur **« Rejoindre un entrepôt existant »**.
...
Votre demande est ensuite examinée par les équipes de l’IGN. Un **accusé de réception** vous est envoyé par courriel. Vérifiez également votre dossier de courriers indésirables.

![Demande envoyée](/img/partenaires/ign/representations-cartographiques-souveraines/creation-cles-donnees-scan/rejoindre-espace/06_demande-envoyee.png){.fr-responsive-img .frx-border-img .frx-img-contained}

Après validation de votre demande, vous recevez un **second courriel d’accueil** dans la communauté de la part des équipes IGN.
