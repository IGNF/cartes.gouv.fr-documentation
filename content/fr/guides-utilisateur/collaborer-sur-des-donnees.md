...
Pour les utilisateurs, le service permettra de participer à la construction et l’évolution de bases de données qui vous concernent, sur votre territoire.

En attendant son intégration, vous pouvez déjà utiliser le site actuel <a href="https://espacecollaboratif.ign.fr/" target="_blank" rel="noopener noreferrer" title="Espace Collaboratif IGN - ouvre une nouvelle fenêtre">Espace Collaboratif IGN</a> pour profiter des fonctionnalités existantes.