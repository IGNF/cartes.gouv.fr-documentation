...
![Panneau de l’outil « Calculer une zone selon un temps de trajet »](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/02_panneau-calculer-une-isochrone.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Choix du mode de déplacement](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/03_choix-du-mode-de-deplacement.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Renseignement d’un point de départ](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/04_point-de-depart.png){.fr-responsive-img .frx-border-img .frx-img-contained}

Sélectionnez ensuite le sens du parcours :

![Choix du sens de parcours](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/05_sens-de-parcours.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Paramétrage du temps ou de la distance de trajet](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/06_temps-ou-distance.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Options de trajets](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/07_options-supplementaires.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Résultat du calcul d’isochrone](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/08_resultat-de-l-isochrone.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Enregistrement de son résultat](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/09_enregistrer-l-isochrone.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Exportation de son résultat en local](/img/guides-utilisateur/visualiseur-cartographique/calculer-une-isochrone/11_exporter-son-isochrone.png){.fr-responsive-img .frx-border-img .frx-img-contained}
