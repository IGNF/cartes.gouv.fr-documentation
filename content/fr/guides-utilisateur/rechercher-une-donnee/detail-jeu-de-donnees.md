...
Une métadonnée catalogue se compose d'une partie **« A propos »**, une partie **« aperçu »** et une partie **« ressources et liens »**. 

![Image décrivant l'entête d'une métadonnée catalogue](/img/guides-utilisateur/rechercher-une-donnee/08_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}

---

## A propos

![Image décrivant la partie à propos](/img/guides-utilisateur/rechercher-une-donnee/19_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Image décrivant le haut de la partie à propos](/img/guides-utilisateur/rechercher-une-donnee/09_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}

En dessous, la partie droite peut être décomposée en cinq éléments :
...
![Image décrivant la partie droite de la partie à propos](/img/guides-utilisateur/rechercher-une-donnee/20_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}

La partie gauche se compose de :
...
![Image décrivant la partie gauche de la partie à propos](/img/guides-utilisateur/rechercher-une-donnee/21_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Image décrivant la partie aperçu](/img/guides-utilisateur/rechercher-une-donnee/22_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Image décrivant la partie lien](/img/guides-utilisateur/rechercher-une-donnee/15_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Image détaillant la partie téléchargements et flux](/img/guides-utilisateur/rechercher-une-donnee/24_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Image détaillant la partie téléchargement](/img/guides-utilisateur/rechercher-une-donnee/26_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Image détaillant la partie téléchargement](/img/guides-utilisateur/rechercher-une-donnee/28_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}
...
![Image détaillant la partie téléchargement](/img/guides-utilisateur/rechercher-une-donnee/29_catalogue.png){.fr-responsive-img .frx-border-img .frx-img-contained}
