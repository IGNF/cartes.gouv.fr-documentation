...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Téléchargement","Annexe","Géocodage","Itinéraire"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Téléchargement"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Géocodage"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Keycloak","Orchestrateur","Itinéraire"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","pg_tileserv","Keycloak","WMTS","WMS-Raster"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","CSW"],
...
<div class="fr-col-12 fr-col-md-6">
    {{ component("card", {
        ...
        tags: ["Géoplateforme","Actualités","WFS","WMS Vecteur","CSW","WMTS"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Keycloak","Itinéraire"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Extraction","Keycloak","TMS"],
...
{{ component("card", {
    ...
    description: "",
    tags: ["Géoplateforme","Actualités","Entrepôt","Géocodage"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Itinéraire"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Geocage","WFS"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","WFS","WMS-V","Géocodage","Téléchargement","WMTS"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","WMS-V"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","ROK4","Orchestrateur","Document","Offre","Entrepôt"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Keycloak","Orchestrateur","Entrepôt","Géocodage"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Entrepôt","Validateur"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Entrepôt"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Global"],
    date: "2025-06-30" | jsDateObject
}) }}
</div>
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Alimentation","Vecteur"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Diffusion","Recherche"],
    date: "2025-03-25" | jsDateObject
}) }}
</div>
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Publication"],
...
{{ component("card", {
    ...
    tags: ["Géoplateforme","Actualités","Alimentation","Rupture"],
