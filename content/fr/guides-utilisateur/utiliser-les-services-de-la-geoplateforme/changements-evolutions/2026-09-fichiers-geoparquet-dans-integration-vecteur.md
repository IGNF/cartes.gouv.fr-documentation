...
- [Altimétrie] Correction d’un bug faisant qu’il n’était plus possible d’accéder au Swagger de l’altimétrie. Dans le même temps, l’URL de celui-ci est maintenant `https://data.geopf.fr/altimetrie/api/index.html`.
