...
description: Correction d’un bug à la lecture de l’encodage TIFF en 2 canaux en WMS-Raster, modification gestion stockage livraison, ajout champ extra à la route catalogs/organizations, correction valeurs aberrantes sur occupation de l’espace de livraison
tags:
    - WMS-Raster
    - WMTS
    - Entrepôt
...
Le stockage est directement porté par l’<span lang="en">_upload_</span> et plus par le <span lang="en">_datastore_</span>. Ce qui va permettre aux administrateurs de changer le stockage des livraisons du <span lang="en">_datastore_</span> sans impacter les livraisons en cours.
...
- [Entrepôt] Correction des valeurs aberrantes sur l’[occupation de l’espace de livraison des <span lang="en">_datastores_</span>](https://data.geopf.fr/api/swagger-ui/index.html#/Entrep%C3%B4t/getStorages)
