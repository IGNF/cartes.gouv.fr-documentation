...
Il est possible de consulter les points d’accès disponibles pour un entrepôt avec la nouvelle route d’API `GET /datastores/{datastore}/endpoints`, avec des filtrages sur les noms, types et quotas.
