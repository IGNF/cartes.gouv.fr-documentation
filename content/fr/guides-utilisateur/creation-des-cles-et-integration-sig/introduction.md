...
- Les **« clés »** existent sous plusieurs formes : **clé hash**, **OAuth2** ou **BASIC** (identifiant : mot de passe en HTTP Basic). Elles peuvent être associées à des règles de filtrage ou de contrôle. Cette clé est ensuite utilisée dans les requêtes vers les services de diffusion.
