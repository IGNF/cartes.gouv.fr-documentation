...
- <strong>Mise en ligne, sur le site [ign.fr](https://www.ign.fr/geoplateforme){target="_blank" rel="noopener noreferrer" title="Géoplateforme - ouvre une nouvelle fenêtre"}, d’un espace d’information</strong> permettant de partager les avancées du programme et les échéances collectives mobilisant les partenaires
...
- le développement du géotuileur qui a fait l’objet d’un atelier réunissant une douzaine de partenaires porteurs de cas d’usage identifiés (collectif des usagers),
...
**Un collectif en appui de la priorisation des besoins et des spécifications.**

**Une douzaine d’acteurs porteurs de cas d’usages ont d’ores et déjà participé à l’atelier collaboratif du 19 octobre 2021 sur le géotuileur :** Agence Bio, BRGM, CRIGE-PACA, SCHAPI, Cerema, Délégation à la sécurité routière, Ineris, MNHN, Pôle ressources national sports de nature, Santé publique France, Shom.
