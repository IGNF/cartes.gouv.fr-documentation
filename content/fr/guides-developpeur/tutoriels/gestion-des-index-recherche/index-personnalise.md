...
summary:
    visible: true
    depth: 3
tertiaryTitle: Création et publication
subTitle: Création et publication de l’index
---
...
Les noms des colonnes doivent exclusivement utiliser des **caractères alphanumériques sans majuscules (a-z, 0-9 et _)**.
...
Et voici un exemple de fichier **JSON** correspondant (le nom des colonnes n’est pas modifiable) :
...
- Pour `"open": false`, l’index custom ne sera accessible qu’aux personnes ayant reçu une permission du gérant de l’index. Pour en savoir plus sur la création de permission et la gestion des clés, suivez [ce lien](../../controle-des-acces/service-de-diffusion/permission/).
