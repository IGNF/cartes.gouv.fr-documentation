...
Il est possible de modifier une donnée vecteur en lui ajoutant des index, des champs ou en recalculant des champs. Toutes ces actions peuvent donner une nouvelle donnée ou être jouées sur une donnée existante.
...
Un exemple d’utilisation est disponible [ici](../derivation/exemple/){target="_blank" rel="noopener noreferrer" title="Exemple d’ajout de colonne avec valeur paramétrable - ouvre une nouvelle fenêtre"}.